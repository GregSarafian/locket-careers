...
const groups: LinkGroup[] = [
  ...
  },
  {
    heading: 'About',
    links: [
      { label: 'Privacy Policy', href: 'https://locket.cam/privacy' },
      { label: 'Terms & Conditions', href: 'https://locket.cam/terms' },
      { label: 'Cookie Policy', href: 'https://locket.cam/cookies' },
      { label: 'Brand', href: 'https://locket.cam/brand' },
    ],
  },
  {
    ...
    links: [
      { label: 'Careers', href: '/' },
      { label: 'Ambassadors', href: 'https://locket.cam/ambassadors' },
      { label: 'Artists', href: 'https://locket.cam/artists' },
      { label: 'Press', href: 'https://locket.cam/press' },
    ],
  },
];
...
const socials = [
  {
    label: 'Instagram',
    href: 'https://instagram.com/locket',
    icon: (
